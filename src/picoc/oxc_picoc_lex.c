...
unsigned char LexUnEscapeCharacterConstant(const char **From, const char *End __attribute((unused)), unsigned char FirstChar, int Base)
{
...
void LexSkipComment(struct LexState *Lexer, char NextChar, enum LexToken *ReturnToken __attribute((unused)))
{
  if (NextChar == '*')
  {
