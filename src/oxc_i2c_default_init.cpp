...
void HAL_I2C_MspInit( I2C_HandleTypeDef *i2c )
{
  if( i2c->Instance == BOARD_I2C_DEFAULT ) {
    ...
    BOARD_I2C_DEFAULT_SCL.enableClk();
    if constexpr ( BOARD_I2C_DEFAULT_SCL.portNum() != BOARD_I2C_DEFAULT_SDA.portNum() ) {
      BOARD_I2C_DEFAULT_SDA.enableClk();
    }
...
void HAL_I2C_MspDeInit( I2C_HandleTypeDef *i2c )
{
  if( i2c->Instance == BOARD_I2C_DEFAULT ) {
    ...
    BOARD_I2C_DEFAULT_SCL.cfgIn();
    BOARD_I2C_DEFAULT_SDA.cfgIn();
