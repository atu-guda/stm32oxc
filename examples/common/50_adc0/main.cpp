...
int main(void)
{
  ...
  UVAR_t = 100000;
  UVAR_n = 20;
  UVAR_c = adc.n_ch_max; // number of channels - 1 for this program, but need for next test
...
// TODO: if ! HAVE_FLOAT
//int vv = v * ( UVAR_v / 100 ) / BOARD_ADC_DEFAULT_MAX; // 100 = 1000/10
