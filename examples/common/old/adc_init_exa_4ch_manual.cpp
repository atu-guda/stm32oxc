...
int adc_init_exa_4ch_manual( ADC_Info &adc, uint32_t presc, uint32_t sampl_cycl, uint8_t n_ch )
{
  ...
  adc.hadc.Init.ExternalTrigConvEdge  = ADC_EXTERNALTRIGCONVEDGE_NONE; // ADC_EXTERNALTRIGCONVEDGE_RISING;
