...
{
  float vmin = arg2float_d( 1, argc, argv,  5,      1, 98 );
  float vmax = arg2float_d( 2, argc, argv, 50, vmin+1, 99 );
  pwmdat.set_min( vmin );
  pwmdat.set_max( vmax );
  return 0;
}
...
int cmd_mk_ladder( int argc, const char * const * argv )
{
  ...
  unsigned n  = arg2long_d(  3, argc, argv,     8, 1, PWMData::max_pwm_steps/2-2 );
