...
#define TIM_CNT_PIN0NUM 0
#define TIM_CNT_PIN1NUM 1
#define TIM_CNT_PINS   ( ( 1 << TIM_CNT_PIN0NUM ) |  ( 1 << TIM_CNT_PIN1NUM ) )
#define TIM_CNT_AF    GPIO_AF1_TIM2
#define TIM_CNT_GPIO  GpioA

// LWM: TIM3.4 C9
#define TIM_LWM       TIM3
#define TIM_LWM_EN    __HAL_RCC_TIM3_CLK_ENABLE();  __HAL_RCC_GPIOC_CLK_ENABLE();
#define TIM_LWM_DIS   __HAL_RCC_TIM3_CLK_DISABLE();
#define TIM_LWM_PIN   GPIO_PIN_9
#define TIM_LWM_AF    GPIO_AF2_TIM3
#define TIM_LWM_GPIO  GpioC
