...
DCL_CMD_REG( start, '\0', "[bits] - start motors"  );
DCL_CMD_REG( stop, 'P', "[bits] - stop motors"  );
DCL_CMD_REG( speed, 'Q', " speed [dev] - set speed for motor turn/s or mm/s"  );
...
DCL_CMD_REG( calc, '\0', "n_tot w_d(mm) w_l(mm) [even] [rtl] - calculate task"  );
