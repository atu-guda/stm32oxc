...
// special configuratio for l12_windmash: I2C at B6(SCL), B7(DAT)
...
#define BOARD_ADC_DEFAULT_PIN0          4
#define BOARD_ADC_DEFAULT_CH0           ADC_CHANNEL_4
#define BOARD_ADC_DEFAULT_GPIO1         GpioA
#define BOARD_ADC_DEFAULT_PIN1          5
