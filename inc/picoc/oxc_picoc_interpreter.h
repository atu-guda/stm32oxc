...
#define IS_NUMERIC_COERCIBLE_PLUS_POINTERS(v,ap) (IS_NUMERIC_COERCIBLE(v) || IS_POINTER_COERCIBLE(v,ap))
  ...
  enum BaseType
  {
    ...
    TypeFunction,               /* a function 10 */
    TypeMacro,                  /* a macro 11 */
    TypePointer,                /* a pointer 12 */
    TypeArray,                  /* an array of a sub-type 13 */
    TypeStruct,                 /* aggregate type 14 */
    TypeUnion,                  /* merged type 15 */
    TypeEnum,                   /* enumerated integer type 16*/
    TypeGotoLabel,              /* a label we can "goto" 17 */
    Type_Type                   /* a type for storing types 18 */
  };
...
# endif
    ...
    struct ValueType *IntPtrType;
    struct ValueType *IntArrayType;
    struct ValueType *FPPtrType;
    struct ValueType *FPArrayType;
...
#if defined(UNIX_HOST) || defined(WIN32) || defined(USE_OXC)
  ...
  int TableSet(Picoc *pc, struct Table *Tbl, const char *Key, struct Value *Val, const char *DeclFileName, int DeclLine, int DeclColumn);
  ...
  int    PicocPlatformSetExitPoint(Picoc *pc);

  /* expression.c */
  struct ExpressionStack;
  enum OperatorOrder // TODO: local?
  {
    OrderNone,
    OrderPrefix,
    OrderInfix,
