 ...
 * =====================================================================================
 *
 *       Filename:  inc/arch/f3/oxc_archdef.h
 *
 *    Description:  STM32F3xx arch-dependent definitions and includes
...
#define EXTI_HANDLER_2  EXTI2_TSC_IRQHandler
...
#define EXTI_IRQ_2  EXTI2_TSC_IRQn
