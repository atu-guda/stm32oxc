...
#ifdef TIM_EXA_NUM
// 1 -> TIM1
#define TIM_EXA        OXC_EVAL2( TIM, TIM_EXA_NUM )
// 1 -> TIM1_BASE
#define TIM_EXA_BASE   OXC_EVAL3( TIM, TIM_EXA_NUM, _BASE )
// 1 -> __TIM1_CLK_ENABLE()
#define TIM_EXA_CLKEN  OXC_EVAL3( __TIM, TIM_EXA_NUM, _CLK_ENABLE()  );
#define TIM_EXA_CLKDIS OXC_EVAL3( __TIM, TIM_EXA_NUM, _CLK_DISABLE() );
#define TIM_EXA_NAME    TO_MACRO_STR(TIM_EXA)
#endif

#ifdef TIM_IN_EXA_NUM
// 2 -> TIM2
#define TIM_IN_EXA        OXC_EVAL2( TIM, TIM_IN_EXA_NUM )
// 1 -> TIM2_BASE
#define TIM_IN_EXA_BASE   OXC_EVAL3( TIM, TIM_IN_EXA_NUM, _BASE )
// 2 -> __TIM2_CLK_ENABLE()
#define TIM_IN_EXA_CLKEN  OXC_EVAL3( __TIM, TIM_IN_EXA_NUM, _CLK_ENABLE()  );
#define TIM_IN_EXA_CLKDIS OXC_EVAL3( __TIM, TIM_IN_EXA_NUM, _CLK_DISABLE() );
#endif
