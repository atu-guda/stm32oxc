...
// definition of resoures on STM32F407ZET based board
...
// base LEDS is F9:F10 - to Vdd // TODO: define for this negation
  ...
  #define BOARD_LEDS_START PF9
  #define BOARD_N_LEDS 2
#else
  #define BOARD_LEDS_START PG2
...
#define BOARD_SPI_DEFAULT_PIN_SCK       PB3
#define BOARD_SPI_DEFAULT_PIN_MISO      PB4
#define BOARD_SPI_DEFAULT_PIN_MOSI      PB5
#define BOARD_SPI_DEFAULT_PIN_SNSS      PB7
#define BOARD_SPI_DEFAULT_PIN_EXT1      PB14
#define BOARD_SPI_DEFAULT_PIN_EXT2      PB15
