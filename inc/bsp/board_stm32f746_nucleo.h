...
#define BOARD_I2C_DEFAULT_TIMING_100    0x30C0EDFF; // 100 kHz over 200 MHz
#define BOARD_I2C_DEFAULT_TIMING_400    0x109035B7; // 400 kHz over 200 MHz
#define BOARD_I2C_DEFAULT_TIMING_1M     0x00902787; // 1   MHz over 200 MHz
...
#define BOARD_CREATE_STD_TASKS        CREATE_STD_TASKS( task_usart3_send );
#define BOARD_CREATE_STD_TASKS_UART   CREATE_STD_TASKS( task_usart3_send );
