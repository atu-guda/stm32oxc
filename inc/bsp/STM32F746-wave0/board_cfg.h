...
#define BOARD_DEFINE_LEDS_EXTRA PinsOut leds( PC0, BOARD_N_LEDS_EXTRA );
...
#define BOARD_UART_DEFAULT_TX         PB6
#define BOARD_UART_DEFAULT_RX         PB7
...
#define BOARD_IN0                       PG2
#define BOARD_IN1                       PG3
#define BOARD_IN2                       PG6
...
#define BOARD_SPI_DEFAULT_PIN_EXT1      PD11
#define BOARD_SPI_DEFAULT_PIN_EXT2      PD12
