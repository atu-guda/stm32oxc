...
#define BOARD_IN0                       PC5
#define BOARD_IN1                       PC6
#define BOARD_IN2                       PC7
...
#define BOARD_SPI_DEFAULT_PIN_EXT1      PC6
#define BOARD_SPI_DEFAULT_PIN_EXT2      PC7
...
// Motor: C6-C9 ?
#define BOARD_MOTOR_DEFAULT_PIN0        PC6
