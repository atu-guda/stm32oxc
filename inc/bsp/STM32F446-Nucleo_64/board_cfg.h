...
#define BOARD_SPI_DEFAULT_GPIO_SCK      PB13
#define BOARD_SPI_DEFAULT_GPIO_MISO     PB14
#define BOARD_SPI_DEFAULT_GPIO_MOSI     PB15
#define BOARD_SPI_DEFAULT_GPIO_SNSS     PB1
#define BOARD_SPI_DEFAULT_EXT1          PB4
#define BOARD_SPI_DEFAULT_EXT2          PB5
