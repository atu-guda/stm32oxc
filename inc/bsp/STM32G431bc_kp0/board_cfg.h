...
#define   TIM_EXA_PIN1          PB6
#define   TIM_EXA_PIN2          PB8
#define   TIM_EXA_PIN3          PB9
// #define   TIM_EXA_PIN4          PA3
#define   TIM_EXA_GPIOAF        GPIO_AF2_TIM8
#define   TIM_EXA_PINS          { TIM_EXA_PIN1, TIM_EXA_PIN2, TIM_EXA_PIN3 }
